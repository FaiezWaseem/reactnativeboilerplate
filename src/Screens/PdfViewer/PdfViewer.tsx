...
export default function PdfViewerscreen({
  route,
}: RootStackScreenProps<"PdfViewerscreen">) {
...
function getPdfHtml(url: string) {
  return `
<!doctype html>
<html lang="en">
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        #canvas_container { width: 100%; height: 85vh; overflow: auto; background: #333; text-align: center; border: solid 3px; }
        .container { width: 100%; height: 100%; margin: auto; }
        #zoom_controls button { padding: 10px; margin-left: 10px; margin-right: 10px; min-width: 40px; min-height: 40px; font-size: 1em; }
        .button { background-color: #555555; border: none; color: white; padding: 15px 15px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; border-radius: 0.5em; }
        #navigation_controls { display: flex; justify-content: center; align-items: center; margin-top: 1rem; }
        #zoom_controls { display: flex; justify-content: center; align-items: center; }
    </style>
</head>
<body>
...
<script>
    ...
    let url = '${url}';
    pdfjsLib.getDocument(url).then((pdf) => { myState.pdf = pdf; render(); });
    function render() {
